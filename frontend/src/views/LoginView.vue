...
const email = ref('admin@sim.monit')
  ...
  <div class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-dark-950">
    ...
    <div class="w-full max-w-md relative z-10">
      ...
      <div class="glass-panel rounded-2xl p-8 border border-slate-800 shadow-2xl">
        <h2 class="text-base font-bold text-slate-100 mb-1">Masuk ke Dashboard</h2>
        <p class="text-xs text-slate-400 mb-6">Silakan masukkan kredensial akun Anda</p>
        ...
        <div class="mt-6 pt-5 border-t border-slate-800 text-center text-xs text-slate-400">
          Belum punya akun?
          <router-link to="/register" class="text-cyan-400 hover:text-cyan-300 font-semibold ml-1">
            Daftar di sini
          </router-link>
        </div>
      </div>
